...
ERR_INVALID_TOKEN: Final[str] = "Invalid or expired token"  # noqa: S105  # user-facing error message, not a secret
...
OAUTH2_TOKEN_URL: Final[str] = "/api/v1/auth/login"  # noqa: S105  # public route path, not a secret
