...
@router.post("/{project_id}/services/{service_name}/start", responses=_NOT_FOUND, response_model=ActionResponse)
...
@router.post("/{project_id}/services/{service_name}/stop", responses=_NOT_FOUND, response_model=ActionResponse)
...
@router.post("/{project_id}/services/{service_name}/restart", responses=_NOT_FOUND, response_model=ActionResponse)
...
@router.post("/{project_id}/services/{service_name}/pause", responses=_NOT_FOUND, response_model=ActionResponse)
...
@router.post("/{project_id}/services/{service_name}/unpause", responses=_NOT_FOUND, response_model=ActionResponse)
